...
public class Exemplo {
    ...
    public static void main(String[] args) {
        ...
        //Ler se a senha possui mais do que 8 caracteres
        if (senha.length() > 8)
       ...
       //Forma 1
    //    char h1 = tempo.charAt(0);//recupera o primeiro caractere da string (2)
    ...
    //    int minutos = Integer.parseInt(String.valueOf(tempo.charAt(3)) + String.valueOf(tempo.charAt(4)));
     ...
     //   JOptionPane.showMessageDialog(null, "Total em minutos " + total);
        ...
        //Forma 2 (Permitir os padrões 1:11, 12:20)indexofSubString
